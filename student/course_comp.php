...
<p>There are many variations of passages of Lorem Ipsum available, but the majo Rity have be suffered alteration in some form, by injected humou or randomis Rity have be suffered alteration in some form, by injected humou or randomis words which donot look even slightly believable. If you are going to use a passage Lorem Ipsum.</p>
                                ...
                                <div class="row">
                                    ...
                                    <h1 align=center>Instructor Detail</h1>
                                    <br>
                                    <br>
                                    <br>
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                        <div class="imgs-zoom-area">
                                            <img id="zoom_030" src="img/product/6.jpg" data-zoom-image="img/product/6.jpg" alt="">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-12"> 
                                        <div class="single-product-info">
                                            <h3 class="text-black-1">Prof. Parth Chauhan </h3>
                                            <h6 class="brand-name-2">Ph.D in Computer Science</h6>
                                            <!--  hr -->
                                            <hr>
...
<p>There are many variations of passages of Lorem Ipsum available, but the majo Rity have be suffered alteration in some form, by injected humou or randomis Rity have be suffered alteration in some form, by injected humou or randomis words which donot look even slightly believable. If you are going to use a passage Lorem Ipsum.</p>
                                            ...
                                            <h3 class="pro-price">Area of Interest: </h3>
                                            <ul>
                                                <li>
                                            ...
                                            <hr>
											<div>
												<a href="/index.php?id=select" class="button extra-small button-black" tabindex="-1">
													<span class="text-uppercase"><?= $btn; ?></span>
												</a>
											</div>
                                        </div>    
                                    </div>
