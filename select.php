                       ...
                       <div class="col-sm-2">
                            <div class="single-video">
                                ...
                                <div class="embed-responsive embed-responsive-16by9" >
                                    <iframe id="myVid" class="embed-responsive-item" src="" frameborder="0" height="20%" width="20%" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-10">
                            <div class="single-video">
                                ...
                                <div class="embed-responsive embed-responsive-16by9" style="height=700px; width=800px;">
